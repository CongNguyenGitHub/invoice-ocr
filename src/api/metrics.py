...
requests_total = Counter(
    "ocr_requests_total",
    "Terminal outcome of submit_receipt",
    ["status"],  # success / pipeline_failed / timeout / storage_error / backpressure
)
e2e_latency_seconds = Histogram("ocr_e2e_latency_seconds", "End-to-end submit_receipt latency (try/finally)")
queue_depth = Gauge("ocr_queue_depth", "LLEN ocr:queue, sampled every 5 s")
queue_soft_warn_total = Counter("ocr_queue_soft_warn_total", "Queue exceeded soft-warn threshold")
